...
- Los datos deben verse ORGÁNICOS, como una recolección real: no alternes categorías en un patrón mecánico (Masculino, Femenino, Masculino, Femenino...), no cicles valores en secuencia (14, 15, 16, 14, 15, 16...), y no repartas las categorías en partes exactamente iguales (mejor 27/33 que 30/30). Respeta los pesos con la irregularidad natural del muestreo.
