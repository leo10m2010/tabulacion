...
export const buildBaseUserContent = (repositoryDomain = null, datos = null, searchContext = null, seleccion = null) => {
  ...
  const planBusqueda = seleccion
    ? "PLAN: en esta solicitud NO tienes herramienta de búsqueda. El PASO 1 (búsqueda en "
      ...
      + "de antecedentes: cita solo trabajos cuya URL aparezca LITERALMENTE en ellos, copiándola "
      + "carácter por carácter. El sistema verificará cada URL y RECHAZARÁ tu respuesta si citas "
      + "alguna que no esté en los resultados, así que no reconstruyas ni completes URLs de "
      + "memoria. Recuerda que los antecedentes internacionales deben ser trabajos de "
      + "instituciones extranjeras: una tesis de una universidad peruana NO cuenta como "
      + "internacional aunque estudie otro país."
    : searchContext
